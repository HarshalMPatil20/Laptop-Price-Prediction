<img src="src/1728956.jpg" alt="image" >
...
- Adjust the parameters and experiment with different models in the `train.py` script.
    ...
    &nbsp; <img src="src/output.png" height="300"   />
